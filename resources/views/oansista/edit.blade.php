@extends('layouts.admin')
	...
	@include('alertas.request')
		{!!Form::model($oansista,['route'=>['oansista.update',$oansista],'method'=>'PUT'])!!}
			<h3>Actualizacion de oansistas</h3>
		...
		<div class="form-group">
			...
			{!! Form::date('fechaNacimiento', \Carbon\Carbon::now(),array('class'=>'form-control')) !!}
		</div>
		<div class="form-group">
		...
		{!!Form::open(['route'=>['oansista.destroy', $oansista], 'method' => 'DELETE'])!!}
